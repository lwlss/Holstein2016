...
plotSimilarFit=function(targ,prof,nearest=c(),farthest=c(),ylim=c()){
	...
	stripchart(profdat,vertical=TRUE,method="jitter",jitter=0.3,pch=16,col=rgb(0,0,0,0.1),cex=0.4,las=2,main=mlab,ylim=ylim,cex.lab=2,xlim=c(1-delta,nExp+delta),cex.main=2,cex.axis=2,ylab="Fitness")
